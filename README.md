...
I would have continued to refine the project, but I became stuck in a cycle of obsessively tweaking hyperparameters and watching "number go down," so my friends, in an effort to get me to shower, changed to password on the Linux partition I was using. I probably could have gotten further along in the project if my partner Nick had actually done his part and wrote the code to convert the videos into numpy arrays when I told him to instead of waiting until the last minute. That's right Nick. I'm still salty about that.
